...
//use middleware for logging, crash reporting, performing anshychrounous task etc
...
// import from redux for combine multiple reducer 
const combineReducers = redux.combineReducers;

// import redux logger 
const reduxLogger = require('redux-logger');
const logger = reduxLogger.createLogger(); //from reduxLogger
const applyMiddleware = redux.applyMiddleware; // from redux
...
const store = createStore(rootReducer, applyMiddleware(logger)); //passed in store with logger
